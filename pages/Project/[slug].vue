          ...
          <div class="prose lg:prose-base">
            <section class="max-w-screen-xl mx-auto mt-6 lg:mt-0">
              ...
              <p class="article-date">
                {{ $dayjs(doc.startDate).format("MMMM D, YYYY") }}–
                {{ $dayjs(doc.endDate).format("MMMM D, YYYY") }}
              </p>
              <div class="prose lg:prose-xl max-w-screen-md">
      ...
      <div class="heading md:py-16 flex flex-wrap mx-auto">
        <div class="w-full h-full text-lg">
          <div class="article max-w-5xl mx-auto">
            ...
            <p class="text-center">
              Sorry, that project wasn't found for some reason!
            </p>
          </div>
        </div>
      </div>
...
.article {
  ...
  h3 {
    @apply text-xl uppercase tracking-wide  mb-2;
  }
